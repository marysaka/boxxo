...
pub type R = crate::R<RXCSRL2_SPEC>;
#[doc = "Register `RXCSRL2` writer"]
pub type W = crate::W<RXCSRL2_SPEC>;
#[doc = "Field `USB_RXCSRL2_RXRDY` reader - Receive Packet Ready"]
pub type USB_RXCSRL2_RXRDY_R = crate::BitReader;
#[doc = "Field `USB_RXCSRL2_RXRDY` writer - Receive Packet Ready"]
pub type USB_RXCSRL2_RXRDY_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
#[doc = "Field `USB_RXCSRL2_FULL` reader - FIFO Full"]
pub type USB_RXCSRL2_FULL_R = crate::BitReader;
#[doc = "Field `USB_RXCSRL2_FULL` writer - FIFO Full"]
pub type USB_RXCSRL2_FULL_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type USB_RXCSRL2_OVER_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
#[doc = "Field `USB_RXCSRL2_DATAERR` reader - Data Error"]
pub type USB_RXCSRL2_DATAERR_R = crate::BitReader;
#[doc = "Field `USB_RXCSRL2_DATAERR` writer - Data Error"]
pub type USB_RXCSRL2_DATAERR_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
#[doc = "Field `USB_RXCSRL2_FLUSH` reader - Flush FIFO"]
pub type USB_RXCSRL2_FLUSH_R = crate::BitReader;
#[doc = "Field `USB_RXCSRL2_FLUSH` writer - Flush FIFO"]
pub type USB_RXCSRL2_FLUSH_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
#[doc = "Field `USB_RXCSRL2_STALL` reader - Send STALL"]
pub type USB_RXCSRL2_STALL_R = crate::BitReader;
#[doc = "Field `USB_RXCSRL2_STALL` writer - Send STALL"]
pub type USB_RXCSRL2_STALL_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
#[doc = "Field `USB_RXCSRL2_STALLED` reader - Endpoint Stalled"]
pub type USB_RXCSRL2_STALLED_R = crate::BitReader;
#[doc = "Field `USB_RXCSRL2_STALLED` writer - Endpoint Stalled"]
pub type USB_RXCSRL2_STALLED_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
#[doc = "Field `USB_RXCSRL2_CLRDT` reader - Clear Data Toggle"]
pub type USB_RXCSRL2_CLRDT_R = crate::BitReader;
#[doc = "Field `USB_RXCSRL2_CLRDT` writer - Clear Data Toggle"]
pub type USB_RXCSRL2_CLRDT_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn usb_rxcsrl2_rxrdy(&mut self) -> USB_RXCSRL2_RXRDY_W<RXCSRL2_SPEC, 0> {
        USB_RXCSRL2_RXRDY_W::new(self)
    }
    #[doc = "Bit 1 - FIFO Full"]
    #[inline(always)]
    #[must_use]
    pub fn usb_rxcsrl2_full(&mut self) -> USB_RXCSRL2_FULL_W<RXCSRL2_SPEC, 1> {
        USB_RXCSRL2_FULL_W::new(self)
    }
    #[doc = "Bit 2 - Overrun"]
    #[inline(always)]
    #[must_use]
    pub fn usb_rxcsrl2_over(&mut self) -> USB_RXCSRL2_OVER_W<RXCSRL2_SPEC, 2> {
        USB_RXCSRL2_OVER_W::new(self)
    }
    #[doc = "Bit 3 - Data Error"]
    #[inline(always)]
    #[must_use]
    pub fn usb_rxcsrl2_dataerr(&mut self) -> USB_RXCSRL2_DATAERR_W<RXCSRL2_SPEC, 3> {
        USB_RXCSRL2_DATAERR_W::new(self)
    }
    #[doc = "Bit 4 - Flush FIFO"]
    #[inline(always)]
    #[must_use]
    pub fn usb_rxcsrl2_flush(&mut self) -> USB_RXCSRL2_FLUSH_W<RXCSRL2_SPEC, 4> {
        USB_RXCSRL2_FLUSH_W::new(self)
    }
    #[doc = "Bit 5 - Send STALL"]
    #[inline(always)]
    #[must_use]
    pub fn usb_rxcsrl2_stall(&mut self) -> USB_RXCSRL2_STALL_W<RXCSRL2_SPEC, 5> {
        USB_RXCSRL2_STALL_W::new(self)
    }
    #[doc = "Bit 6 - Endpoint Stalled"]
    #[inline(always)]
    #[must_use]
    pub fn usb_rxcsrl2_stalled(&mut self) -> USB_RXCSRL2_STALLED_W<RXCSRL2_SPEC, 6> {
        USB_RXCSRL2_STALLED_W::new(self)
    }
    #[doc = "Bit 7 - Clear Data Toggle"]
    #[inline(always)]
    #[must_use]
    pub fn usb_rxcsrl2_clrdt(&mut self) -> USB_RXCSRL2_CLRDT_W<RXCSRL2_SPEC, 7> {
...
#[doc = "USB Receive Control and Status Endpoint 2 Low\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`rxcsrl2::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`rxcsrl2::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
