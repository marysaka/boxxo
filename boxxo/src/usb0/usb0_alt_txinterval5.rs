...
pub type R = crate::R<USB0_ALT_TXINTERVAL5_SPEC>;
#[doc = "Register `TXINTERVAL5` writer"]
pub type W = crate::W<USB0_ALT_TXINTERVAL5_SPEC>;
#[doc = "Field `USB_TXINTERVAL5_NAKLMT` reader - NAK Limit"]
pub type USB_TXINTERVAL5_NAKLMT_R = crate::FieldReader;
#[doc = "Field `USB_TXINTERVAL5_NAKLMT` writer - NAK Limit"]
pub type USB_TXINTERVAL5_NAKLMT_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 8, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn usb_txinterval5_naklmt(
        &mut self,
    ) -> USB_TXINTERVAL5_NAKLMT_W<USB0_ALT_TXINTERVAL5_SPEC, 0> {
...
#[doc = "USB Host Transmit Interval Endpoint 5\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`usb0_alt_txinterval5::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`usb0_alt_txinterval5::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
