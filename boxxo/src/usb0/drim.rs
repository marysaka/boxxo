...
pub type R = crate::R<DRIM_SPEC>;
#[doc = "Register `DRIM` writer"]
pub type W = crate::W<DRIM_SPEC>;
#[doc = "Field `USB_DRIM_RESUME` reader - RESUME Interrupt Mask"]
pub type USB_DRIM_RESUME_R = crate::BitReader;
#[doc = "Field `USB_DRIM_RESUME` writer - RESUME Interrupt Mask"]
pub type USB_DRIM_RESUME_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn usb_drim_resume(&mut self) -> USB_DRIM_RESUME_W<DRIM_SPEC, 0> {
...
#[doc = "USB Device RESUME Interrupt Mask\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`drim::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`drim::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
