...
pub type R = crate::R<EPCRIS_SPEC>;
#[doc = "Register `EPCRIS` writer"]
pub type W = crate::W<EPCRIS_SPEC>;
#[doc = "Field `USB_EPCRIS_PF` reader - USB Power Fault Interrupt Status"]
pub type USB_EPCRIS_PF_R = crate::BitReader;
#[doc = "Field `USB_EPCRIS_PF` writer - USB Power Fault Interrupt Status"]
pub type USB_EPCRIS_PF_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn usb_epcris_pf(&mut self) -> USB_EPCRIS_PF_W<EPCRIS_SPEC, 0> {
...
#[doc = "USB External Power Control Raw Interrupt Status\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`epcris::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`epcris::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
