...
pub type R = crate::R<VDCIM_SPEC>;
#[doc = "Register `VDCIM` writer"]
pub type W = crate::W<VDCIM_SPEC>;
#[doc = "Field `USB_VDCIM_VD` reader - VBUS Droop Interrupt Mask"]
pub type USB_VDCIM_VD_R = crate::BitReader;
#[doc = "Field `USB_VDCIM_VD` writer - VBUS Droop Interrupt Mask"]
pub type USB_VDCIM_VD_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn usb_vdcim_vd(&mut self) -> USB_VDCIM_VD_W<VDCIM_SPEC, 0> {
