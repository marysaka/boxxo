...
pub type R = crate::R<TXINTERVAL4_SPEC>;
#[doc = "Register `TXINTERVAL4` writer"]
pub type W = crate::W<TXINTERVAL4_SPEC>;
#[doc = "Field `USB_TXINTERVAL4_TXPOLL` reader - TX Polling"]
pub type USB_TXINTERVAL4_TXPOLL_R = crate::FieldReader;
#[doc = "Field `USB_TXINTERVAL4_TXPOLL` writer - TX Polling"]
pub type USB_TXINTERVAL4_TXPOLL_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 8, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn usb_txinterval4_txpoll(&mut self) -> USB_TXINTERVAL4_TXPOLL_W<TXINTERVAL4_SPEC, 0> {
...
#[doc = "USB Host Transmit Interval Endpoint 4\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`txinterval4::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`txinterval4::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
