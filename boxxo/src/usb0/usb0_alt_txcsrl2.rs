...
pub type R = crate::R<USB0_ALT_TXCSRL2_SPEC>;
#[doc = "Register `TXCSRL2` writer"]
pub type W = crate::W<USB0_ALT_TXCSRL2_SPEC>;
#[doc = "Field `USB_TXCSRL2_UNDRN` reader - Underrun"]
pub type USB_TXCSRL2_UNDRN_R = crate::BitReader;
#[doc = "Field `USB_TXCSRL2_UNDRN` writer - Underrun"]
pub type USB_TXCSRL2_UNDRN_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
#[doc = "Field `USB_TXCSRL2_STALL` reader - Send STALL"]
pub type USB_TXCSRL2_STALL_R = crate::BitReader;
#[doc = "Field `USB_TXCSRL2_STALL` writer - Send STALL"]
pub type USB_TXCSRL2_STALL_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
impl R {
    #[doc = "Bit 2 - Underrun"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn usb_txcsrl2_undrn(&mut self) -> USB_TXCSRL2_UNDRN_W<USB0_ALT_TXCSRL2_SPEC, 2> {
        USB_TXCSRL2_UNDRN_W::new(self)
    }
    #[doc = "Bit 4 - Send STALL"]
    #[inline(always)]
    #[must_use]
    pub fn usb_txcsrl2_stall(&mut self) -> USB_TXCSRL2_STALL_W<USB0_ALT_TXCSRL2_SPEC, 4> {
