...
pub type R = crate::R<RXCSRH2_SPEC>;
#[doc = "Register `RXCSRH2` writer"]
pub type W = crate::W<RXCSRH2_SPEC>;
#[doc = "Field `USB_RXCSRH2_DT` reader - Data Toggle"]
pub type USB_RXCSRH2_DT_R = crate::BitReader;
#[doc = "Field `USB_RXCSRH2_DT` writer - Data Toggle"]
pub type USB_RXCSRH2_DT_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
#[doc = "Field `USB_RXCSRH2_DTWE` reader - Data Toggle Write Enable"]
pub type USB_RXCSRH2_DTWE_R = crate::BitReader;
#[doc = "Field `USB_RXCSRH2_DTWE` writer - Data Toggle Write Enable"]
pub type USB_RXCSRH2_DTWE_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
#[doc = "Field `USB_RXCSRH2_DMAMOD` reader - DMA Request Mode"]
pub type USB_RXCSRH2_DMAMOD_R = crate::BitReader;
#[doc = "Field `USB_RXCSRH2_DMAMOD` writer - DMA Request Mode"]
pub type USB_RXCSRH2_DMAMOD_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
#[doc = "Field `USB_RXCSRH2_PIDERR` reader - PID Error"]
pub type USB_RXCSRH2_PIDERR_R = crate::BitReader;
#[doc = "Field `USB_RXCSRH2_PIDERR` writer - PID Error"]
pub type USB_RXCSRH2_PIDERR_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
#[doc = "Field `USB_RXCSRH2_DMAEN` reader - DMA Request Enable"]
pub type USB_RXCSRH2_DMAEN_R = crate::BitReader;
#[doc = "Field `USB_RXCSRH2_DMAEN` writer - DMA Request Enable"]
pub type USB_RXCSRH2_DMAEN_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
#[doc = "Field `USB_RXCSRH2_AUTORQ` reader - Auto Request"]
pub type USB_RXCSRH2_AUTORQ_R = crate::BitReader;
#[doc = "Field `USB_RXCSRH2_AUTORQ` writer - Auto Request"]
pub type USB_RXCSRH2_AUTORQ_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
#[doc = "Field `USB_RXCSRH2_AUTOCL` reader - Auto Clear"]
pub type USB_RXCSRH2_AUTOCL_R = crate::BitReader;
#[doc = "Field `USB_RXCSRH2_AUTOCL` writer - Auto Clear"]
pub type USB_RXCSRH2_AUTOCL_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn usb_rxcsrh2_dt(&mut self) -> USB_RXCSRH2_DT_W<RXCSRH2_SPEC, 1> {
        USB_RXCSRH2_DT_W::new(self)
    }
    #[doc = "Bit 2 - Data Toggle Write Enable"]
    #[inline(always)]
    #[must_use]
    pub fn usb_rxcsrh2_dtwe(&mut self) -> USB_RXCSRH2_DTWE_W<RXCSRH2_SPEC, 2> {
        USB_RXCSRH2_DTWE_W::new(self)
    }
    #[doc = "Bit 3 - DMA Request Mode"]
    #[inline(always)]
    #[must_use]
    pub fn usb_rxcsrh2_dmamod(&mut self) -> USB_RXCSRH2_DMAMOD_W<RXCSRH2_SPEC, 3> {
        USB_RXCSRH2_DMAMOD_W::new(self)
    }
    #[doc = "Bit 4 - PID Error"]
    #[inline(always)]
    #[must_use]
    pub fn usb_rxcsrh2_piderr(&mut self) -> USB_RXCSRH2_PIDERR_W<RXCSRH2_SPEC, 4> {
        USB_RXCSRH2_PIDERR_W::new(self)
    }
    #[doc = "Bit 5 - DMA Request Enable"]
    #[inline(always)]
    #[must_use]
    pub fn usb_rxcsrh2_dmaen(&mut self) -> USB_RXCSRH2_DMAEN_W<RXCSRH2_SPEC, 5> {
        USB_RXCSRH2_DMAEN_W::new(self)
    }
    #[doc = "Bit 6 - Auto Request"]
    #[inline(always)]
    #[must_use]
    pub fn usb_rxcsrh2_autorq(&mut self) -> USB_RXCSRH2_AUTORQ_W<RXCSRH2_SPEC, 6> {
        USB_RXCSRH2_AUTORQ_W::new(self)
    }
    #[doc = "Bit 7 - Auto Clear"]
    #[inline(always)]
    #[must_use]
    pub fn usb_rxcsrh2_autocl(&mut self) -> USB_RXCSRH2_AUTOCL_W<RXCSRH2_SPEC, 7> {
