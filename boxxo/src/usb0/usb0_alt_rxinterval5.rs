...
pub type R = crate::R<USB0_ALT_RXINTERVAL5_SPEC>;
#[doc = "Register `RXINTERVAL5` writer"]
pub type W = crate::W<USB0_ALT_RXINTERVAL5_SPEC>;
#[doc = "Field `USB_RXINTERVAL5_NAKLMT` reader - NAK Limit"]
pub type USB_RXINTERVAL5_NAKLMT_R = crate::FieldReader;
#[doc = "Field `USB_RXINTERVAL5_NAKLMT` writer - NAK Limit"]
pub type USB_RXINTERVAL5_NAKLMT_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 8, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn usb_rxinterval5_naklmt(
        &mut self,
    ) -> USB_RXINTERVAL5_NAKLMT_W<USB0_ALT_RXINTERVAL5_SPEC, 0> {
