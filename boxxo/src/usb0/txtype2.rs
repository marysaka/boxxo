...
pub type R = crate::R<TXTYPE2_SPEC>;
#[doc = "Register `TXTYPE2` writer"]
pub type W = crate::W<TXTYPE2_SPEC>;
#[doc = "Field `USB_TXTYPE2_TEP` reader - Target Endpoint Number"]
pub type USB_TXTYPE2_TEP_R = crate::FieldReader;
#[doc = "Field `USB_TXTYPE2_TEP` writer - Target Endpoint Number"]
pub type USB_TXTYPE2_TEP_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 4, O>;
#[doc = "Field `USB_TXTYPE2_PROTO` reader - Protocol"]
pub type USB_TXTYPE2_PROTO_R = crate::FieldReader<USB_TXTYPE2_PROTO_A>;
#[doc = "Protocol\n\nValue on reset: 0"]
...
impl crate::FieldSpec for USB_TXTYPE2_PROTO_A {
    type Ux = u8;
}
impl USB_TXTYPE2_PROTO_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> USB_TXTYPE2_PROTO_A {
        match self.bits {
...
pub type USB_TXTYPE2_PROTO_W<'a, REG, const O: u8> =
    crate::FieldWriterSafe<'a, REG, 2, O, USB_TXTYPE2_PROTO_A>;
impl<'a, REG, const O: u8> USB_TXTYPE2_PROTO_W<'a, REG, O>
where
    ...
    REG::Ux: From<u8>,
{
    #[doc = "Control"]
    #[inline(always)]
    pub fn usb_txtype2_proto_ctrl(self) -> &'a mut crate::W<REG> {
        self.variant(USB_TXTYPE2_PROTO_A::USB_TXTYPE2_PROTO_CTRL)
    }
    #[doc = "Isochronous"]
    #[inline(always)]
    pub fn usb_txtype2_proto_isoc(self) -> &'a mut crate::W<REG> {
        self.variant(USB_TXTYPE2_PROTO_A::USB_TXTYPE2_PROTO_ISOC)
    }
    #[doc = "Bulk"]
    #[inline(always)]
    pub fn usb_txtype2_proto_bulk(self) -> &'a mut crate::W<REG> {
        self.variant(USB_TXTYPE2_PROTO_A::USB_TXTYPE2_PROTO_BULK)
    }
    #[doc = "Interrupt"]
    #[inline(always)]
    pub fn usb_txtype2_proto_int(self) -> &'a mut crate::W<REG> {
        self.variant(USB_TXTYPE2_PROTO_A::USB_TXTYPE2_PROTO_INT)
    }
}
#[doc = "Field `USB_TXTYPE2_SPEED` reader - Operating Speed"]
pub type USB_TXTYPE2_SPEED_R = crate::FieldReader<USB_TXTYPE2_SPEED_A>;
#[doc = "Operating Speed\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
#[repr(u8)]
...
impl crate::FieldSpec for USB_TXTYPE2_SPEED_A {
    type Ux = u8;
}
impl USB_TXTYPE2_SPEED_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> Option<USB_TXTYPE2_SPEED_A> {
        match self.bits {
            0 => Some(USB_TXTYPE2_SPEED_A::USB_TXTYPE2_SPEED_DFLT),
            2 => Some(USB_TXTYPE2_SPEED_A::USB_TXTYPE2_SPEED_FULL),
            3 => Some(USB_TXTYPE2_SPEED_A::USB_TXTYPE2_SPEED_LOW),
            _ => None,
        }
    }
    #[doc = "Default"]
...
pub type USB_TXTYPE2_SPEED_W<'a, REG, const O: u8> =
    crate::FieldWriter<'a, REG, 2, O, USB_TXTYPE2_SPEED_A>;
impl<'a, REG, const O: u8> USB_TXTYPE2_SPEED_W<'a, REG, O>
where
    REG: crate::Writable + crate::RegisterSpec,
    REG::Ux: From<u8>,
{
    #[doc = "Default"]
    #[inline(always)]
    pub fn usb_txtype2_speed_dflt(self) -> &'a mut crate::W<REG> {
        self.variant(USB_TXTYPE2_SPEED_A::USB_TXTYPE2_SPEED_DFLT)
    }
    #[doc = "Full"]
    #[inline(always)]
    pub fn usb_txtype2_speed_full(self) -> &'a mut crate::W<REG> {
        self.variant(USB_TXTYPE2_SPEED_A::USB_TXTYPE2_SPEED_FULL)
    }
    #[doc = "Low"]
    #[inline(always)]
    pub fn usb_txtype2_speed_low(self) -> &'a mut crate::W<REG> {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn usb_txtype2_tep(&mut self) -> USB_TXTYPE2_TEP_W<TXTYPE2_SPEC, 0> {
        USB_TXTYPE2_TEP_W::new(self)
    }
    #[doc = "Bits 4:5 - Protocol"]
    #[inline(always)]
    #[must_use]
    pub fn usb_txtype2_proto(&mut self) -> USB_TXTYPE2_PROTO_W<TXTYPE2_SPEC, 4> {
        USB_TXTYPE2_PROTO_W::new(self)
    }
    #[doc = "Bits 6:7 - Operating Speed"]
    #[inline(always)]
    #[must_use]
    pub fn usb_txtype2_speed(&mut self) -> USB_TXTYPE2_SPEED_W<TXTYPE2_SPEC, 6> {
...
#[doc = "USB Host Transmit Configure Type Endpoint 2\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`txtype2::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`txtype2::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
