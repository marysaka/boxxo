...
pub type R = crate::R<TXHUBPORT4_SPEC>;
#[doc = "Register `TXHUBPORT4` writer"]
pub type W = crate::W<TXHUBPORT4_SPEC>;
#[doc = "Field `USB_TXHUBPORT4_PORT` reader - Hub Port"]
pub type USB_TXHUBPORT4_PORT_R = crate::FieldReader;
#[doc = "Field `USB_TXHUBPORT4_PORT` writer - Hub Port"]
pub type USB_TXHUBPORT4_PORT_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 7, O>;
impl R {
    #[doc = "Bits 0:6 - Hub Port"]
    #[inline(always)]
    pub fn usb_txhubport4_port(&self) -> USB_TXHUBPORT4_PORT_R {
        USB_TXHUBPORT4_PORT_R::new(self.bits & 0x7f)
    }
}
impl W {
    #[doc = "Bits 0:6 - Hub Port"]
    #[inline(always)]
    #[must_use]
    pub fn usb_txhubport4_port(&mut self) -> USB_TXHUBPORT4_PORT_W<TXHUBPORT4_SPEC, 0> {
