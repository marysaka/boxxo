...
pub type R = crate::R<RXHUBADDR2_SPEC>;
#[doc = "Register `RXHUBADDR2` writer"]
pub type W = crate::W<RXHUBADDR2_SPEC>;
#[doc = "Field `USB_RXHUBADDR2_ADDR` reader - Hub Address"]
pub type USB_RXHUBADDR2_ADDR_R = crate::FieldReader;
#[doc = "Field `USB_RXHUBADDR2_ADDR` writer - Hub Address"]
pub type USB_RXHUBADDR2_ADDR_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 7, O>;
impl R {
    #[doc = "Bits 0:6 - Hub Address"]
    #[inline(always)]
    pub fn usb_rxhubaddr2_addr(&self) -> USB_RXHUBADDR2_ADDR_R {
        USB_RXHUBADDR2_ADDR_R::new(self.bits & 0x7f)
    }
}
impl W {
    #[doc = "Bits 0:6 - Hub Address"]
    #[inline(always)]
    #[must_use]
    pub fn usb_rxhubaddr2_addr(&mut self) -> USB_RXHUBADDR2_ADDR_W<RXHUBADDR2_SPEC, 0> {
