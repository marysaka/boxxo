...
pub type R = crate::R<TXHUBADDR2_SPEC>;
#[doc = "Register `TXHUBADDR2` writer"]
pub type W = crate::W<TXHUBADDR2_SPEC>;
#[doc = "Field `USB_TXHUBADDR2_ADDR` reader - Hub Address"]
pub type USB_TXHUBADDR2_ADDR_R = crate::FieldReader;
#[doc = "Field `USB_TXHUBADDR2_ADDR` writer - Hub Address"]
pub type USB_TXHUBADDR2_ADDR_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 7, O>;
impl R {
    #[doc = "Bits 0:6 - Hub Address"]
    #[inline(always)]
    pub fn usb_txhubaddr2_addr(&self) -> USB_TXHUBADDR2_ADDR_R {
        USB_TXHUBADDR2_ADDR_R::new(self.bits & 0x7f)
    }
}
impl W {
    #[doc = "Bits 0:6 - Hub Address"]
    #[inline(always)]
    #[must_use]
    pub fn usb_txhubaddr2_addr(&mut self) -> USB_TXHUBADDR2_ADDR_W<TXHUBADDR2_SPEC, 0> {
...
#[doc = "USB Transmit Hub Address Endpoint 2\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`txhubaddr2::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`txhubaddr2::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
