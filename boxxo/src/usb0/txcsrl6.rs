...
pub type R = crate::R<TXCSRL6_SPEC>;
#[doc = "Register `TXCSRL6` writer"]
pub type W = crate::W<TXCSRL6_SPEC>;
#[doc = "Field `USB_TXCSRL6_TXRDY` reader - Transmit Packet Ready"]
pub type USB_TXCSRL6_TXRDY_R = crate::BitReader;
#[doc = "Field `USB_TXCSRL6_TXRDY` writer - Transmit Packet Ready"]
pub type USB_TXCSRL6_TXRDY_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
#[doc = "Field `USB_TXCSRL6_FIFONE` reader - FIFO Not Empty"]
pub type USB_TXCSRL6_FIFONE_R = crate::BitReader;
#[doc = "Field `USB_TXCSRL6_FIFONE` writer - FIFO Not Empty"]
pub type USB_TXCSRL6_FIFONE_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
#[doc = "Field `USB_TXCSRL6_ERROR` reader - Error"]
pub type USB_TXCSRL6_ERROR_R = crate::BitReader;
#[doc = "Field `USB_TXCSRL6_ERROR` writer - Error"]
pub type USB_TXCSRL6_ERROR_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
#[doc = "Field `USB_TXCSRL6_FLUSH` reader - Flush FIFO"]
pub type USB_TXCSRL6_FLUSH_R = crate::BitReader;
#[doc = "Field `USB_TXCSRL6_FLUSH` writer - Flush FIFO"]
pub type USB_TXCSRL6_FLUSH_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
#[doc = "Field `USB_TXCSRL6_SETUP` reader - Setup Packet"]
pub type USB_TXCSRL6_SETUP_R = crate::BitReader;
#[doc = "Field `USB_TXCSRL6_SETUP` writer - Setup Packet"]
pub type USB_TXCSRL6_SETUP_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
#[doc = "Field `USB_TXCSRL6_STALLED` reader - Endpoint Stalled"]
pub type USB_TXCSRL6_STALLED_R = crate::BitReader;
#[doc = "Field `USB_TXCSRL6_STALLED` writer - Endpoint Stalled"]
pub type USB_TXCSRL6_STALLED_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
#[doc = "Field `USB_TXCSRL6_CLRDT` reader - Clear Data Toggle"]
pub type USB_TXCSRL6_CLRDT_R = crate::BitReader;
#[doc = "Field `USB_TXCSRL6_CLRDT` writer - Clear Data Toggle"]
pub type USB_TXCSRL6_CLRDT_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
#[doc = "Field `USB_TXCSRL6_NAKTO` reader - NAK Timeout"]
pub type USB_TXCSRL6_NAKTO_R = crate::BitReader;
#[doc = "Field `USB_TXCSRL6_NAKTO` writer - NAK Timeout"]
pub type USB_TXCSRL6_NAKTO_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn usb_txcsrl6_txrdy(&mut self) -> USB_TXCSRL6_TXRDY_W<TXCSRL6_SPEC, 0> {
        USB_TXCSRL6_TXRDY_W::new(self)
    }
    #[doc = "Bit 1 - FIFO Not Empty"]
    #[inline(always)]
    #[must_use]
    pub fn usb_txcsrl6_fifone(&mut self) -> USB_TXCSRL6_FIFONE_W<TXCSRL6_SPEC, 1> {
        USB_TXCSRL6_FIFONE_W::new(self)
    }
    #[doc = "Bit 2 - Error"]
    #[inline(always)]
    #[must_use]
    pub fn usb_txcsrl6_error(&mut self) -> USB_TXCSRL6_ERROR_W<TXCSRL6_SPEC, 2> {
        USB_TXCSRL6_ERROR_W::new(self)
    }
    #[doc = "Bit 3 - Flush FIFO"]
    #[inline(always)]
    #[must_use]
    pub fn usb_txcsrl6_flush(&mut self) -> USB_TXCSRL6_FLUSH_W<TXCSRL6_SPEC, 3> {
        USB_TXCSRL6_FLUSH_W::new(self)
    }
    #[doc = "Bit 4 - Setup Packet"]
    #[inline(always)]
    #[must_use]
    pub fn usb_txcsrl6_setup(&mut self) -> USB_TXCSRL6_SETUP_W<TXCSRL6_SPEC, 4> {
        USB_TXCSRL6_SETUP_W::new(self)
    }
    #[doc = "Bit 5 - Endpoint Stalled"]
    #[inline(always)]
    #[must_use]
    pub fn usb_txcsrl6_stalled(&mut self) -> USB_TXCSRL6_STALLED_W<TXCSRL6_SPEC, 5> {
        USB_TXCSRL6_STALLED_W::new(self)
    }
    #[doc = "Bit 6 - Clear Data Toggle"]
    #[inline(always)]
    #[must_use]
    pub fn usb_txcsrl6_clrdt(&mut self) -> USB_TXCSRL6_CLRDT_W<TXCSRL6_SPEC, 6> {
        USB_TXCSRL6_CLRDT_W::new(self)
    }
    #[doc = "Bit 7 - NAK Timeout"]
    #[inline(always)]
    #[must_use]
    pub fn usb_txcsrl6_nakto(&mut self) -> USB_TXCSRL6_NAKTO_W<TXCSRL6_SPEC, 7> {
...
#[doc = "USB Transmit Control and Status Endpoint 6 Low\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`txcsrl6::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`txcsrl6::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
