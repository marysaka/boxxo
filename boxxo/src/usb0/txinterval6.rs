...
pub type R = crate::R<TXINTERVAL6_SPEC>;
#[doc = "Register `TXINTERVAL6` writer"]
pub type W = crate::W<TXINTERVAL6_SPEC>;
#[doc = "Field `USB_TXINTERVAL6_TXPOLL` reader - TX Polling"]
pub type USB_TXINTERVAL6_TXPOLL_R = crate::FieldReader;
#[doc = "Field `USB_TXINTERVAL6_TXPOLL` writer - TX Polling"]
pub type USB_TXINTERVAL6_TXPOLL_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 8, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn usb_txinterval6_txpoll(&mut self) -> USB_TXINTERVAL6_TXPOLL_W<TXINTERVAL6_SPEC, 0> {
...
#[doc = "USB Host Transmit Interval Endpoint 6\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`txinterval6::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`txinterval6::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
