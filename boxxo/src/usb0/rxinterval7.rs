...
pub type R = crate::R<RXINTERVAL7_SPEC>;
#[doc = "Register `RXINTERVAL7` writer"]
pub type W = crate::W<RXINTERVAL7_SPEC>;
#[doc = "Field `USB_RXINTERVAL7_TXPOLL` reader - RX Polling"]
pub type USB_RXINTERVAL7_TXPOLL_R = crate::FieldReader;
#[doc = "Field `USB_RXINTERVAL7_TXPOLL` writer - RX Polling"]
pub type USB_RXINTERVAL7_TXPOLL_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 8, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn usb_rxinterval7_txpoll(&mut self) -> USB_RXINTERVAL7_TXPOLL_W<RXINTERVAL7_SPEC, 0> {
...
#[doc = "USB Host Receive Polling Interval Endpoint 7\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`rxinterval7::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`rxinterval7::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
