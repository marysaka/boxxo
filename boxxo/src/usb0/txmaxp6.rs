...
pub type R = crate::R<TXMAXP6_SPEC>;
#[doc = "Register `TXMAXP6` writer"]
pub type W = crate::W<TXMAXP6_SPEC>;
#[doc = "Field `USB_TXMAXP6_MAXLOAD` reader - Maximum Payload"]
pub type USB_TXMAXP6_MAXLOAD_R = crate::FieldReader<u16>;
#[doc = "Field `USB_TXMAXP6_MAXLOAD` writer - Maximum Payload"]
pub type USB_TXMAXP6_MAXLOAD_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 11, O, u16>;
impl R {
    #[doc = "Bits 0:10 - Maximum Payload"]
    #[inline(always)]
    pub fn usb_txmaxp6_maxload(&self) -> USB_TXMAXP6_MAXLOAD_R {
        USB_TXMAXP6_MAXLOAD_R::new(self.bits & 0x07ff)
    }
}
impl W {
    #[doc = "Bits 0:10 - Maximum Payload"]
    #[inline(always)]
    #[must_use]
    pub fn usb_txmaxp6_maxload(&mut self) -> USB_TXMAXP6_MAXLOAD_W<TXMAXP6_SPEC, 0> {
...
#[doc = "USB Maximum Transmit Data Endpoint 6\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`txmaxp6::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`txmaxp6::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
