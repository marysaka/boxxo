...
pub type R = crate::R<TXCSRL7_SPEC>;
#[doc = "Register `TXCSRL7` writer"]
pub type W = crate::W<TXCSRL7_SPEC>;
#[doc = "Field `USB_TXCSRL7_TXRDY` reader - Transmit Packet Ready"]
pub type USB_TXCSRL7_TXRDY_R = crate::BitReader;
#[doc = "Field `USB_TXCSRL7_TXRDY` writer - Transmit Packet Ready"]
pub type USB_TXCSRL7_TXRDY_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
#[doc = "Field `USB_TXCSRL7_FIFONE` reader - FIFO Not Empty"]
pub type USB_TXCSRL7_FIFONE_R = crate::BitReader;
#[doc = "Field `USB_TXCSRL7_FIFONE` writer - FIFO Not Empty"]
pub type USB_TXCSRL7_FIFONE_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
#[doc = "Field `USB_TXCSRL7_ERROR` reader - Error"]
pub type USB_TXCSRL7_ERROR_R = crate::BitReader;
#[doc = "Field `USB_TXCSRL7_ERROR` writer - Error"]
pub type USB_TXCSRL7_ERROR_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
#[doc = "Field `USB_TXCSRL7_FLUSH` reader - Flush FIFO"]
pub type USB_TXCSRL7_FLUSH_R = crate::BitReader;
#[doc = "Field `USB_TXCSRL7_FLUSH` writer - Flush FIFO"]
pub type USB_TXCSRL7_FLUSH_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
#[doc = "Field `USB_TXCSRL7_SETUP` reader - Setup Packet"]
pub type USB_TXCSRL7_SETUP_R = crate::BitReader;
#[doc = "Field `USB_TXCSRL7_SETUP` writer - Setup Packet"]
pub type USB_TXCSRL7_SETUP_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
#[doc = "Field `USB_TXCSRL7_STALLED` reader - Endpoint Stalled"]
pub type USB_TXCSRL7_STALLED_R = crate::BitReader;
#[doc = "Field `USB_TXCSRL7_STALLED` writer - Endpoint Stalled"]
pub type USB_TXCSRL7_STALLED_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
#[doc = "Field `USB_TXCSRL7_CLRDT` reader - Clear Data Toggle"]
pub type USB_TXCSRL7_CLRDT_R = crate::BitReader;
#[doc = "Field `USB_TXCSRL7_CLRDT` writer - Clear Data Toggle"]
pub type USB_TXCSRL7_CLRDT_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
#[doc = "Field `USB_TXCSRL7_NAKTO` reader - NAK Timeout"]
pub type USB_TXCSRL7_NAKTO_R = crate::BitReader;
#[doc = "Field `USB_TXCSRL7_NAKTO` writer - NAK Timeout"]
pub type USB_TXCSRL7_NAKTO_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn usb_txcsrl7_txrdy(&mut self) -> USB_TXCSRL7_TXRDY_W<TXCSRL7_SPEC, 0> {
        USB_TXCSRL7_TXRDY_W::new(self)
    }
    #[doc = "Bit 1 - FIFO Not Empty"]
    #[inline(always)]
    #[must_use]
    pub fn usb_txcsrl7_fifone(&mut self) -> USB_TXCSRL7_FIFONE_W<TXCSRL7_SPEC, 1> {
        USB_TXCSRL7_FIFONE_W::new(self)
    }
    #[doc = "Bit 2 - Error"]
    #[inline(always)]
    #[must_use]
    pub fn usb_txcsrl7_error(&mut self) -> USB_TXCSRL7_ERROR_W<TXCSRL7_SPEC, 2> {
        USB_TXCSRL7_ERROR_W::new(self)
    }
    #[doc = "Bit 3 - Flush FIFO"]
    #[inline(always)]
    #[must_use]
    pub fn usb_txcsrl7_flush(&mut self) -> USB_TXCSRL7_FLUSH_W<TXCSRL7_SPEC, 3> {
        USB_TXCSRL7_FLUSH_W::new(self)
    }
    #[doc = "Bit 4 - Setup Packet"]
    #[inline(always)]
    #[must_use]
    pub fn usb_txcsrl7_setup(&mut self) -> USB_TXCSRL7_SETUP_W<TXCSRL7_SPEC, 4> {
        USB_TXCSRL7_SETUP_W::new(self)
    }
    #[doc = "Bit 5 - Endpoint Stalled"]
    #[inline(always)]
    #[must_use]
    pub fn usb_txcsrl7_stalled(&mut self) -> USB_TXCSRL7_STALLED_W<TXCSRL7_SPEC, 5> {
        USB_TXCSRL7_STALLED_W::new(self)
    }
    #[doc = "Bit 6 - Clear Data Toggle"]
    #[inline(always)]
    #[must_use]
    pub fn usb_txcsrl7_clrdt(&mut self) -> USB_TXCSRL7_CLRDT_W<TXCSRL7_SPEC, 6> {
        USB_TXCSRL7_CLRDT_W::new(self)
    }
    #[doc = "Bit 7 - NAK Timeout"]
    #[inline(always)]
    #[must_use]
    pub fn usb_txcsrl7_nakto(&mut self) -> USB_TXCSRL7_NAKTO_W<TXCSRL7_SPEC, 7> {
...
#[doc = "USB Transmit Control and Status Endpoint 7 Low\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`txcsrl7::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`txcsrl7::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
