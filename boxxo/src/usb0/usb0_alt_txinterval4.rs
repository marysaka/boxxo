...
pub type R = crate::R<USB0_ALT_TXINTERVAL4_SPEC>;
#[doc = "Register `TXINTERVAL4` writer"]
pub type W = crate::W<USB0_ALT_TXINTERVAL4_SPEC>;
#[doc = "Field `USB_TXINTERVAL4_NAKLMT` reader - NAK Limit"]
pub type USB_TXINTERVAL4_NAKLMT_R = crate::FieldReader;
#[doc = "Field `USB_TXINTERVAL4_NAKLMT` writer - NAK Limit"]
pub type USB_TXINTERVAL4_NAKLMT_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 8, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn usb_txinterval4_naklmt(
        &mut self,
    ) -> USB_TXINTERVAL4_NAKLMT_W<USB0_ALT_TXINTERVAL4_SPEC, 0> {
