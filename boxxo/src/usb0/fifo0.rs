...
pub type USB_FIFO0_EPDATA_R = crate::FieldReader<u32>;
#[doc = "Field `USB_FIFO0_EPDATA` writer - Endpoint Data"]
pub type USB_FIFO0_EPDATA_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 32, O, u32>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn usb_fifo0_epdata(&mut self) -> USB_FIFO0_EPDATA_W<FIFO0_SPEC, 0> {
...
#[doc = "USB FIFO Endpoint 0\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`fifo0::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`fifo0::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
