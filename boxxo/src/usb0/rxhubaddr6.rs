...
pub type R = crate::R<RXHUBADDR6_SPEC>;
#[doc = "Register `RXHUBADDR6` writer"]
pub type W = crate::W<RXHUBADDR6_SPEC>;
#[doc = "Field `USB_RXHUBADDR6_ADDR` reader - Hub Address"]
pub type USB_RXHUBADDR6_ADDR_R = crate::FieldReader;
#[doc = "Field `USB_RXHUBADDR6_ADDR` writer - Hub Address"]
pub type USB_RXHUBADDR6_ADDR_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 7, O>;
impl R {
    #[doc = "Bits 0:6 - Hub Address"]
    #[inline(always)]
    pub fn usb_rxhubaddr6_addr(&self) -> USB_RXHUBADDR6_ADDR_R {
        USB_RXHUBADDR6_ADDR_R::new(self.bits & 0x7f)
    }
}
impl W {
    #[doc = "Bits 0:6 - Hub Address"]
    #[inline(always)]
    #[must_use]
    pub fn usb_rxhubaddr6_addr(&mut self) -> USB_RXHUBADDR6_ADDR_W<RXHUBADDR6_SPEC, 0> {
