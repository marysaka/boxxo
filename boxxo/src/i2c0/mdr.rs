...
#[doc = "Field `I2C_MDR_DATA` reader - Data Transferred"]
pub type I2C_MDR_DATA_R = crate::FieldReader;
#[doc = "Field `I2C_MDR_DATA` writer - Data Transferred"]
pub type I2C_MDR_DATA_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 8, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn i2c_mdr_data(&mut self) -> I2C_MDR_DATA_W<MDR_SPEC, 0> {
