...
pub type R = crate::R<ACSTAT1_SPEC>;
#[doc = "Register `ACSTAT1` writer"]
pub type W = crate::W<ACSTAT1_SPEC>;
#[doc = "Field `COMP_ACSTAT1_OVAL` reader - Comparator Output Value"]
pub type COMP_ACSTAT1_OVAL_R = crate::BitReader;
#[doc = "Field `COMP_ACSTAT1_OVAL` writer - Comparator Output Value"]
pub type COMP_ACSTAT1_OVAL_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn comp_acstat1_oval(&mut self) -> COMP_ACSTAT1_OVAL_W<ACSTAT1_SPEC, 1> {
...
#[doc = "Analog Comparator Status 1\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`acstat1::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`acstat1::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
