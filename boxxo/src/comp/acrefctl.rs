...
pub type R = crate::R<ACREFCTL_SPEC>;
#[doc = "Register `ACREFCTL` writer"]
pub type W = crate::W<ACREFCTL_SPEC>;
#[doc = "Field `COMP_ACREFCTL_VREF` reader - Resistor Ladder Voltage Ref"]
pub type COMP_ACREFCTL_VREF_R = crate::FieldReader;
#[doc = "Field `COMP_ACREFCTL_VREF` writer - Resistor Ladder Voltage Ref"]
pub type COMP_ACREFCTL_VREF_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 4, O>;
#[doc = "Field `COMP_ACREFCTL_RNG` reader - Resistor Ladder Range"]
pub type COMP_ACREFCTL_RNG_R = crate::BitReader;
#[doc = "Field `COMP_ACREFCTL_RNG` writer - Resistor Ladder Range"]
pub type COMP_ACREFCTL_RNG_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
#[doc = "Field `COMP_ACREFCTL_EN` reader - Resistor Ladder Enable"]
pub type COMP_ACREFCTL_EN_R = crate::BitReader;
#[doc = "Field `COMP_ACREFCTL_EN` writer - Resistor Ladder Enable"]
pub type COMP_ACREFCTL_EN_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn comp_acrefctl_vref(&mut self) -> COMP_ACREFCTL_VREF_W<ACREFCTL_SPEC, 0> {
        COMP_ACREFCTL_VREF_W::new(self)
    }
    #[doc = "Bit 8 - Resistor Ladder Range"]
    #[inline(always)]
    #[must_use]
    pub fn comp_acrefctl_rng(&mut self) -> COMP_ACREFCTL_RNG_W<ACREFCTL_SPEC, 8> {
        COMP_ACREFCTL_RNG_W::new(self)
    }
    #[doc = "Bit 9 - Resistor Ladder Enable"]
    #[inline(always)]
    #[must_use]
    pub fn comp_acrefctl_en(&mut self) -> COMP_ACREFCTL_EN_W<ACREFCTL_SPEC, 9> {
...
#[doc = "Analog Comparator Reference Voltage Control\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`acrefctl::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`acrefctl::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
