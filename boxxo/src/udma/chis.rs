...
#[doc = "Field `UDMA_CHIS` reader - Channel \\[n\\]
Interrupt Status"]
pub type UDMA_CHIS_R = crate::FieldReader<u32>;
#[doc = "Field `UDMA_CHIS` writer - Channel \\[n\\]
Interrupt Status"]
pub type UDMA_CHIS_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 32, O, u32>;
impl R {
    #[doc = "Bits 0:31 - Channel \\[n\\]
Interrupt Status"]
    #[inline(always)]
    pub fn udma_chis(&self) -> UDMA_CHIS_R {
        UDMA_CHIS_R::new(self.bits)
    }
}
impl W {
    #[doc = "Bits 0:31 - Channel \\[n\\]
Interrupt Status"]
    #[inline(always)]
    #[must_use]
    pub fn udma_chis(&mut self) -> UDMA_CHIS_W<CHIS_SPEC, 0> {
        UDMA_CHIS_W::new(self)
    }
