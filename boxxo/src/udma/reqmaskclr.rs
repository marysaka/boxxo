...
#[doc = "Field `UDMA_REQMASKCLR_CLR` writer - Channel \\[n\\]
Request Mask Clear"]
pub type UDMA_REQMASKCLR_CLR_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 32, O, u32>;
impl W {
    #[doc = "Bits 0:31 - Channel \\[n\\]
Request Mask Clear"]
    #[inline(always)]
    #[must_use]
    pub fn udma_reqmaskclr_clr(&mut self) -> UDMA_REQMASKCLR_CLR_W<REQMASKCLR_SPEC, 0> {
        UDMA_REQMASKCLR_CLR_W::new(self)
    }
