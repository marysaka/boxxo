...
Useburst Set"]
pub type UDMA_USEBURSTSET_SET_R = crate::FieldReader<u32>;
#[doc = "Field `UDMA_USEBURSTSET_SET` writer - Channel \\[n\\]
Useburst Set"]
pub type UDMA_USEBURSTSET_SET_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 32, O, u32>;
impl R {
...
Useburst Set"]
    #[inline(always)]
    #[must_use]
    pub fn udma_useburstset_set(&mut self) -> UDMA_USEBURSTSET_SET_W<USEBURSTSET_SPEC, 0> {
