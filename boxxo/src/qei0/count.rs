...
#[doc = "Field `QEI_COUNT` reader - Velocity Pulse Count"]
pub type QEI_COUNT_R = crate::FieldReader<u32>;
#[doc = "Field `QEI_COUNT` writer - Velocity Pulse Count"]
pub type QEI_COUNT_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 32, O, u32>;
impl R {
    #[doc = "Bits 0:31 - Velocity Pulse Count"]
    #[inline(always)]
    pub fn qei_count(&self) -> QEI_COUNT_R {
        QEI_COUNT_R::new(self.bits)
    }
}
impl W {
    #[doc = "Bits 0:31 - Velocity Pulse Count"]
    #[inline(always)]
    #[must_use]
    pub fn qei_count(&mut self) -> QEI_COUNT_W<COUNT_SPEC, 0> {
        QEI_COUNT_W::new(self)
    }
