...
pub type R = crate::R<TXRQ1_SPEC>;
#[doc = "Register `TXRQ1` writer"]
pub type W = crate::W<TXRQ1_SPEC>;
#[doc = "Field `CAN_TXRQ1_TXRQST` reader - Transmission Request Bits"]
pub type CAN_TXRQ1_TXRQST_R = crate::FieldReader<u16>;
#[doc = "Field `CAN_TXRQ1_TXRQST` writer - Transmission Request Bits"]
pub type CAN_TXRQ1_TXRQST_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 16, O, u16>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn can_txrq1_txrqst(&mut self) -> CAN_TXRQ1_TXRQST_W<TXRQ1_SPEC, 0> {
