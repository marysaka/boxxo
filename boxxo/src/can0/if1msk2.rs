...
pub type R = crate::R<IF1MSK2_SPEC>;
#[doc = "Register `IF1MSK2` writer"]
pub type W = crate::W<IF1MSK2_SPEC>;
#[doc = "Field `CAN_IF1MSK2_IDMSK` reader - Identifier Mask"]
pub type CAN_IF1MSK2_IDMSK_R = crate::FieldReader<u16>;
#[doc = "Field `CAN_IF1MSK2_IDMSK` writer - Identifier Mask"]
pub type CAN_IF1MSK2_IDMSK_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 13, O, u16>;
#[doc = "Field `CAN_IF1MSK2_MDIR` reader - Mask Message Direction"]
pub type CAN_IF1MSK2_MDIR_R = crate::BitReader;
#[doc = "Field `CAN_IF1MSK2_MDIR` writer - Mask Message Direction"]
pub type CAN_IF1MSK2_MDIR_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
#[doc = "Field `CAN_IF1MSK2_MXTD` reader - Mask Extended Identifier"]
pub type CAN_IF1MSK2_MXTD_R = crate::BitReader;
#[doc = "Field `CAN_IF1MSK2_MXTD` writer - Mask Extended Identifier"]
pub type CAN_IF1MSK2_MXTD_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn can_if1msk2_idmsk(&mut self) -> CAN_IF1MSK2_IDMSK_W<IF1MSK2_SPEC, 0> {
        CAN_IF1MSK2_IDMSK_W::new(self)
    }
    #[doc = "Bit 14 - Mask Message Direction"]
    #[inline(always)]
    #[must_use]
    pub fn can_if1msk2_mdir(&mut self) -> CAN_IF1MSK2_MDIR_W<IF1MSK2_SPEC, 14> {
        CAN_IF1MSK2_MDIR_W::new(self)
    }
    #[doc = "Bit 15 - Mask Extended Identifier"]
    #[inline(always)]
    #[must_use]
    pub fn can_if1msk2_mxtd(&mut self) -> CAN_IF1MSK2_MXTD_W<IF1MSK2_SPEC, 15> {
...
#[doc = "CAN IF1 Mask 2\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`if1msk2::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`if1msk2::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
