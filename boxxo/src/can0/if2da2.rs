...
pub type R = crate::R<IF2DA2_SPEC>;
#[doc = "Register `IF2DA2` writer"]
pub type W = crate::W<IF2DA2_SPEC>;
#[doc = "Field `CAN_IF2DA2_DATA` reader - Data"]
pub type CAN_IF2DA2_DATA_R = crate::FieldReader<u16>;
#[doc = "Field `CAN_IF2DA2_DATA` writer - Data"]
pub type CAN_IF2DA2_DATA_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 16, O, u16>;
impl R {
    #[doc = "Bits 0:15 - Data"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn can_if2da2_data(&mut self) -> CAN_IF2DA2_DATA_W<IF2DA2_SPEC, 0> {
...
#[doc = "CAN IF2 Data A2\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`if2da2::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`if2da2::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
