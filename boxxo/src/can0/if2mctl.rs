...
pub type R = crate::R<IF2MCTL_SPEC>;
#[doc = "Register `IF2MCTL` writer"]
pub type W = crate::W<IF2MCTL_SPEC>;
#[doc = "Field `CAN_IF2MCTL_DLC` reader - Data Length Code"]
pub type CAN_IF2MCTL_DLC_R = crate::FieldReader;
#[doc = "Field `CAN_IF2MCTL_DLC` writer - Data Length Code"]
pub type CAN_IF2MCTL_DLC_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 4, O>;
#[doc = "Field `CAN_IF2MCTL_EOB` reader - End of Buffer"]
pub type CAN_IF2MCTL_EOB_R = crate::BitReader;
#[doc = "Field `CAN_IF2MCTL_EOB` writer - End of Buffer"]
pub type CAN_IF2MCTL_EOB_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
#[doc = "Field `CAN_IF2MCTL_TXRQST` reader - Transmit Request"]
pub type CAN_IF2MCTL_TXRQST_R = crate::BitReader;
#[doc = "Field `CAN_IF2MCTL_TXRQST` writer - Transmit Request"]
pub type CAN_IF2MCTL_TXRQST_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
#[doc = "Field `CAN_IF2MCTL_RMTEN` reader - Remote Enable"]
pub type CAN_IF2MCTL_RMTEN_R = crate::BitReader;
#[doc = "Field `CAN_IF2MCTL_RMTEN` writer - Remote Enable"]
pub type CAN_IF2MCTL_RMTEN_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
#[doc = "Field `CAN_IF2MCTL_RXIE` reader - Receive Interrupt Enable"]
pub type CAN_IF2MCTL_RXIE_R = crate::BitReader;
#[doc = "Field `CAN_IF2MCTL_RXIE` writer - Receive Interrupt Enable"]
pub type CAN_IF2MCTL_RXIE_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
#[doc = "Field `CAN_IF2MCTL_TXIE` reader - Transmit Interrupt Enable"]
pub type CAN_IF2MCTL_TXIE_R = crate::BitReader;
#[doc = "Field `CAN_IF2MCTL_TXIE` writer - Transmit Interrupt Enable"]
pub type CAN_IF2MCTL_TXIE_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
#[doc = "Field `CAN_IF2MCTL_UMASK` reader - Use Acceptance Mask"]
pub type CAN_IF2MCTL_UMASK_R = crate::BitReader;
#[doc = "Field `CAN_IF2MCTL_UMASK` writer - Use Acceptance Mask"]
pub type CAN_IF2MCTL_UMASK_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
#[doc = "Field `CAN_IF2MCTL_INTPND` reader - Interrupt Pending"]
pub type CAN_IF2MCTL_INTPND_R = crate::BitReader;
#[doc = "Field `CAN_IF2MCTL_INTPND` writer - Interrupt Pending"]
pub type CAN_IF2MCTL_INTPND_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
#[doc = "Field `CAN_IF2MCTL_MSGLST` reader - Message Lost"]
pub type CAN_IF2MCTL_MSGLST_R = crate::BitReader;
#[doc = "Field `CAN_IF2MCTL_MSGLST` writer - Message Lost"]
pub type CAN_IF2MCTL_MSGLST_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
#[doc = "Field `CAN_IF2MCTL_NEWDAT` reader - New Data"]
pub type CAN_IF2MCTL_NEWDAT_R = crate::BitReader;
#[doc = "Field `CAN_IF2MCTL_NEWDAT` writer - New Data"]
pub type CAN_IF2MCTL_NEWDAT_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn can_if2mctl_dlc(&mut self) -> CAN_IF2MCTL_DLC_W<IF2MCTL_SPEC, 0> {
        CAN_IF2MCTL_DLC_W::new(self)
    }
    #[doc = "Bit 7 - End of Buffer"]
    #[inline(always)]
    #[must_use]
    pub fn can_if2mctl_eob(&mut self) -> CAN_IF2MCTL_EOB_W<IF2MCTL_SPEC, 7> {
        CAN_IF2MCTL_EOB_W::new(self)
    }
    #[doc = "Bit 8 - Transmit Request"]
    #[inline(always)]
    #[must_use]
    pub fn can_if2mctl_txrqst(&mut self) -> CAN_IF2MCTL_TXRQST_W<IF2MCTL_SPEC, 8> {
        CAN_IF2MCTL_TXRQST_W::new(self)
    }
    #[doc = "Bit 9 - Remote Enable"]
    #[inline(always)]
    #[must_use]
    pub fn can_if2mctl_rmten(&mut self) -> CAN_IF2MCTL_RMTEN_W<IF2MCTL_SPEC, 9> {
        CAN_IF2MCTL_RMTEN_W::new(self)
    }
    #[doc = "Bit 10 - Receive Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn can_if2mctl_rxie(&mut self) -> CAN_IF2MCTL_RXIE_W<IF2MCTL_SPEC, 10> {
        CAN_IF2MCTL_RXIE_W::new(self)
    }
    #[doc = "Bit 11 - Transmit Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn can_if2mctl_txie(&mut self) -> CAN_IF2MCTL_TXIE_W<IF2MCTL_SPEC, 11> {
        CAN_IF2MCTL_TXIE_W::new(self)
    }
    #[doc = "Bit 12 - Use Acceptance Mask"]
    #[inline(always)]
    #[must_use]
    pub fn can_if2mctl_umask(&mut self) -> CAN_IF2MCTL_UMASK_W<IF2MCTL_SPEC, 12> {
        CAN_IF2MCTL_UMASK_W::new(self)
    }
    #[doc = "Bit 13 - Interrupt Pending"]
    #[inline(always)]
    #[must_use]
    pub fn can_if2mctl_intpnd(&mut self) -> CAN_IF2MCTL_INTPND_W<IF2MCTL_SPEC, 13> {
        CAN_IF2MCTL_INTPND_W::new(self)
    }
    #[doc = "Bit 14 - Message Lost"]
    #[inline(always)]
    #[must_use]
    pub fn can_if2mctl_msglst(&mut self) -> CAN_IF2MCTL_MSGLST_W<IF2MCTL_SPEC, 14> {
        CAN_IF2MCTL_MSGLST_W::new(self)
    }
    #[doc = "Bit 15 - New Data"]
    #[inline(always)]
    #[must_use]
    pub fn can_if2mctl_newdat(&mut self) -> CAN_IF2MCTL_NEWDAT_W<IF2MCTL_SPEC, 15> {
