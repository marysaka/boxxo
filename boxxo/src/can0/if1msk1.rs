...
pub type R = crate::R<IF1MSK1_SPEC>;
#[doc = "Register `IF1MSK1` writer"]
pub type W = crate::W<IF1MSK1_SPEC>;
#[doc = "Field `CAN_IF1MSK1_IDMSK` reader - Identifier Mask"]
pub type CAN_IF1MSK1_IDMSK_R = crate::FieldReader<u16>;
#[doc = "Field `CAN_IF1MSK1_IDMSK` writer - Identifier Mask"]
pub type CAN_IF1MSK1_IDMSK_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 16, O, u16>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn can_if1msk1_idmsk(&mut self) -> CAN_IF1MSK1_IDMSK_W<IF1MSK1_SPEC, 0> {
...
#[doc = "CAN IF1 Mask 1\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`if1msk1::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`if1msk1::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
