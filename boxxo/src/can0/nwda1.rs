...
pub type R = crate::R<NWDA1_SPEC>;
#[doc = "Register `NWDA1` writer"]
pub type W = crate::W<NWDA1_SPEC>;
#[doc = "Field `CAN_NWDA1_NEWDAT` reader - New Data Bits"]
pub type CAN_NWDA1_NEWDAT_R = crate::FieldReader<u16>;
#[doc = "Field `CAN_NWDA1_NEWDAT` writer - New Data Bits"]
pub type CAN_NWDA1_NEWDAT_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 16, O, u16>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn can_nwda1_newdat(&mut self) -> CAN_NWDA1_NEWDAT_W<NWDA1_SPEC, 0> {
...
#[doc = "CAN New Data 1\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`nwda1::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`nwda1::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
