...
pub type R = crate::R<MSG1VAL_SPEC>;
#[doc = "Register `MSG1VAL` writer"]
pub type W = crate::W<MSG1VAL_SPEC>;
#[doc = "Field `CAN_MSG1VAL_MSGVAL` reader - Message Valid Bits"]
pub type CAN_MSG1VAL_MSGVAL_R = crate::FieldReader<u16>;
#[doc = "Field `CAN_MSG1VAL_MSGVAL` writer - Message Valid Bits"]
pub type CAN_MSG1VAL_MSGVAL_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 16, O, u16>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn can_msg1val_msgval(&mut self) -> CAN_MSG1VAL_MSGVAL_W<MSG1VAL_SPEC, 0> {
...
#[doc = "CAN Message 1 Valid\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`msg1val::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`msg1val::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
