...
pub type R = crate::R<TXRQ2_SPEC>;
#[doc = "Register `TXRQ2` writer"]
pub type W = crate::W<TXRQ2_SPEC>;
#[doc = "Field `CAN_TXRQ2_TXRQST` reader - Transmission Request Bits"]
pub type CAN_TXRQ2_TXRQST_R = crate::FieldReader<u16>;
#[doc = "Field `CAN_TXRQ2_TXRQST` writer - Transmission Request Bits"]
pub type CAN_TXRQ2_TXRQST_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 16, O, u16>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn can_txrq2_txrqst(&mut self) -> CAN_TXRQ2_TXRQST_W<TXRQ2_SPEC, 0> {
...
#[doc = "CAN Transmission Request 2\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`txrq2::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`txrq2::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
