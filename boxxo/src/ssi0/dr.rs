...
#[doc = "Field `SSI_DR_DATA` reader - SSI Receive/Transmit Data"]
pub type SSI_DR_DATA_R = crate::FieldReader<u16>;
#[doc = "Field `SSI_DR_DATA` writer - SSI Receive/Transmit Data"]
pub type SSI_DR_DATA_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 16, O, u16>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ssi_dr_data(&mut self) -> SSI_DR_DATA_W<DR_SPEC, 0> {
        SSI_DR_DATA_W::new(self)
    }
