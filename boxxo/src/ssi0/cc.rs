...
pub type SSI_CC_CS_R = crate::FieldReader<SSI_CC_CS_A>;
#[doc = "SSI Baud Clock Source\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
#[repr(u8)]
pub enum SSI_CC_CS_A {
    #[doc = "0: Either the system clock (if the PLL bypass is in effect) or the PLL output (default)"]
    SSI_CC_CS_SYSPLL = 0,
    #[doc = "5: PIOSC"]
    SSI_CC_CS_PIOSC = 5,
}
...
impl crate::FieldSpec for SSI_CC_CS_A {
    type Ux = u8;
}
impl SSI_CC_CS_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> Option<SSI_CC_CS_A> {
        match self.bits {
    ...
    #[doc = "Either the system clock (if the PLL bypass is in effect) or the PLL output (default)"]
    #[inline(always)]
...
pub type SSI_CC_CS_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 4, O, SSI_CC_CS_A>;
impl<'a, REG, const O: u8> SSI_CC_CS_W<'a, REG, O>
where
    ...
    REG::Ux: From<u8>,
{
    #[doc = "Either the system clock (if the PLL bypass is in effect) or the PLL output (default)"]
    #[inline(always)]
    pub fn ssi_cc_cs_syspll(self) -> &'a mut crate::W<REG> {
        self.variant(SSI_CC_CS_A::SSI_CC_CS_SYSPLL)
    }
    #[doc = "PIOSC"]
    #[inline(always)]
    pub fn ssi_cc_cs_piosc(self) -> &'a mut crate::W<REG> {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ssi_cc_cs(&mut self) -> SSI_CC_CS_W<CC_SPEC, 0> {
