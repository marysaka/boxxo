...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn adc_ssdc0_s0dcsel(&mut self) -> ADC_SSDC0_S0DCSEL_W<SSDC0_SPEC, 0> {
        ADC_SSDC0_S0DCSEL_W::new(self)
    }
    #[doc = "Bits 4:7 - Sample 1 Digital Comparator Select"]
    #[inline(always)]
    #[must_use]
    pub fn adc_ssdc0_s1dcsel(&mut self) -> ADC_SSDC0_S1DCSEL_W<SSDC0_SPEC, 4> {
        ADC_SSDC0_S1DCSEL_W::new(self)
    }
    #[doc = "Bits 8:11 - Sample 2 Digital Comparator Select"]
    #[inline(always)]
    #[must_use]
    pub fn adc_ssdc0_s2dcsel(&mut self) -> ADC_SSDC0_S2DCSEL_W<SSDC0_SPEC, 8> {
        ADC_SSDC0_S2DCSEL_W::new(self)
    }
    #[doc = "Bits 12:15 - Sample 3 Digital Comparator Select"]
    #[inline(always)]
    #[must_use]
    pub fn adc_ssdc0_s3dcsel(&mut self) -> ADC_SSDC0_S3DCSEL_W<SSDC0_SPEC, 12> {
        ADC_SSDC0_S3DCSEL_W::new(self)
    }
    #[doc = "Bits 16:19 - Sample 4 Digital Comparator Select"]
    #[inline(always)]
    #[must_use]
    pub fn adc_ssdc0_s4dcsel(&mut self) -> ADC_SSDC0_S4DCSEL_W<SSDC0_SPEC, 16> {
        ADC_SSDC0_S4DCSEL_W::new(self)
    }
    #[doc = "Bits 20:23 - Sample 5 Digital Comparator Select"]
    #[inline(always)]
    #[must_use]
    pub fn adc_ssdc0_s5dcsel(&mut self) -> ADC_SSDC0_S5DCSEL_W<SSDC0_SPEC, 20> {
        ADC_SSDC0_S5DCSEL_W::new(self)
    }
    #[doc = "Bits 24:27 - Sample 6 Digital Comparator Select"]
    #[inline(always)]
    #[must_use]
    pub fn adc_ssdc0_s6dcsel(&mut self) -> ADC_SSDC0_S6DCSEL_W<SSDC0_SPEC, 24> {
        ADC_SSDC0_S6DCSEL_W::new(self)
    }
    #[doc = "Bits 28:31 - Sample 7 Digital Comparator Select"]
    #[inline(always)]
    #[must_use]
    pub fn adc_ssdc0_s7dcsel(&mut self) -> ADC_SSDC0_S7DCSEL_W<SSDC0_SPEC, 28> {
...
#[doc = "ADC Sample Sequence 0 Digital Comparator Select\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ssdc0::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ssdc0::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
