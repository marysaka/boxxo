...
pub type R = crate::R<SSFIFO0_SPEC>;
#[doc = "Register `SSFIFO0` writer"]
pub type W = crate::W<SSFIFO0_SPEC>;
#[doc = "Field `ADC_SSFIFO0_DATA` reader - Conversion Result Data"]
pub type ADC_SSFIFO0_DATA_R = crate::FieldReader<u16>;
#[doc = "Field `ADC_SSFIFO0_DATA` writer - Conversion Result Data"]
pub type ADC_SSFIFO0_DATA_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 12, O, u16>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn adc_ssfifo0_data(&mut self) -> ADC_SSFIFO0_DATA_W<SSFIFO0_SPEC, 0> {
...
#[doc = "ADC Sample Sequence Result FIFO 0\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ssfifo0::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ssfifo0::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
