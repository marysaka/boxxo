...
pub type R = crate::R<UART_ALT_ECR_SPEC>;
#[doc = "Register `ECR` writer"]
pub type W = crate::W<UART_ALT_ECR_SPEC>;
#[doc = "Field `UART_ECR_DATA` reader - Error Clear"]
pub type UART_ECR_DATA_R = crate::FieldReader;
#[doc = "Field `UART_ECR_DATA` writer - Error Clear"]
pub type UART_ECR_DATA_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 8, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn uart_ecr_data(&mut self) -> UART_ECR_DATA_W<UART_ALT_ECR_SPEC, 0> {
