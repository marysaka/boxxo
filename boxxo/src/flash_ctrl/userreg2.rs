...
pub type R = crate::R<USERREG2_SPEC>;
#[doc = "Register `USERREG2` writer"]
pub type W = crate::W<USERREG2_SPEC>;
#[doc = "Field `FLASH_USERREG2_DATA` reader - User Data"]
pub type FLASH_USERREG2_DATA_R = crate::FieldReader<u32>;
#[doc = "Field `FLASH_USERREG2_DATA` writer - User Data"]
pub type FLASH_USERREG2_DATA_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 32, O, u32>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn flash_userreg2_data(&mut self) -> FLASH_USERREG2_DATA_W<USERREG2_SPEC, 0> {
...
#[doc = "User Register 2\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`userreg2::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`userreg2::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
