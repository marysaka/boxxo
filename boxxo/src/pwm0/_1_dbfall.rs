...
pub type R = crate::R<_1_DBFALL_SPEC>;
#[doc = "Register `_1_DBFALL` writer"]
pub type W = crate::W<_1_DBFALL_SPEC>;
#[doc = "Field `PWM_1_DBFALL_FALLDELAY` reader - Dead-Band Fall Delay"]
pub type PWM_1_DBFALL_FALLDELAY_R = crate::FieldReader<u16>;
#[doc = "Field `PWM_1_DBFALL_FALLDELAY` writer - Dead-Band Fall Delay"]
pub type PWM_1_DBFALL_FALLDELAY_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 12, O, u16>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pwm_1_dbfall_falldelay(&mut self) -> PWM_1_DBFALL_FALLDELAY_W<_1_DBFALL_SPEC, 0> {
