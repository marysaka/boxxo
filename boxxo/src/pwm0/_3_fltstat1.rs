...
#[doc = "PWM3 Fault Status 1\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`_3_fltstat1::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
