...
pub type R = crate::R<_0_DBRISE_SPEC>;
#[doc = "Register `_0_DBRISE` writer"]
pub type W = crate::W<_0_DBRISE_SPEC>;
#[doc = "Field `PWM_0_DBRISE_DELAY` reader - Dead-Band Rise Delay"]
pub type PWM_0_DBRISE_DELAY_R = crate::FieldReader<u16>;
#[doc = "Field `PWM_0_DBRISE_DELAY` writer - Dead-Band Rise Delay"]
pub type PWM_0_DBRISE_DELAY_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 12, O, u16>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pwm_0_dbrise_delay(&mut self) -> PWM_0_DBRISE_DELAY_W<_0_DBRISE_SPEC, 0> {
