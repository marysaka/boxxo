...
pub type R = crate::R<_2_ISC_SPEC>;
#[doc = "Register `_2_ISC` writer"]
pub type W = crate::W<_2_ISC_SPEC>;
#[doc = "Field `PWM_2_ISC_INTCNTZERO` reader - Counter=0 Interrupt"]
pub type PWM_2_ISC_INTCNTZERO_R = crate::BitReader;
#[doc = "Field `PWM_2_ISC_INTCNTZERO` writer - Counter=0 Interrupt"]
pub type PWM_2_ISC_INTCNTZERO_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
#[doc = "Field `PWM_2_ISC_INTCNTLOAD` reader - Counter=Load Interrupt"]
pub type PWM_2_ISC_INTCNTLOAD_R = crate::BitReader;
#[doc = "Field `PWM_2_ISC_INTCNTLOAD` writer - Counter=Load Interrupt"]
pub type PWM_2_ISC_INTCNTLOAD_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
#[doc = "Field `PWM_2_ISC_INTCMPAU` reader - Comparator A Up Interrupt"]
pub type PWM_2_ISC_INTCMPAU_R = crate::BitReader;
#[doc = "Field `PWM_2_ISC_INTCMPAU` writer - Comparator A Up Interrupt"]
pub type PWM_2_ISC_INTCMPAU_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
#[doc = "Field `PWM_2_ISC_INTCMPAD` reader - Comparator A Down Interrupt"]
pub type PWM_2_ISC_INTCMPAD_R = crate::BitReader;
#[doc = "Field `PWM_2_ISC_INTCMPAD` writer - Comparator A Down Interrupt"]
pub type PWM_2_ISC_INTCMPAD_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
#[doc = "Field `PWM_2_ISC_INTCMPBU` reader - Comparator B Up Interrupt"]
pub type PWM_2_ISC_INTCMPBU_R = crate::BitReader;
#[doc = "Field `PWM_2_ISC_INTCMPBU` writer - Comparator B Up Interrupt"]
pub type PWM_2_ISC_INTCMPBU_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
#[doc = "Field `PWM_2_ISC_INTCMPBD` reader - Comparator B Down Interrupt"]
pub type PWM_2_ISC_INTCMPBD_R = crate::BitReader;
#[doc = "Field `PWM_2_ISC_INTCMPBD` writer - Comparator B Down Interrupt"]
pub type PWM_2_ISC_INTCMPBD_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pwm_2_isc_intcntzero(&mut self) -> PWM_2_ISC_INTCNTZERO_W<_2_ISC_SPEC, 0> {
        PWM_2_ISC_INTCNTZERO_W::new(self)
    }
    #[doc = "Bit 1 - Counter=Load Interrupt"]
    #[inline(always)]
    #[must_use]
    pub fn pwm_2_isc_intcntload(&mut self) -> PWM_2_ISC_INTCNTLOAD_W<_2_ISC_SPEC, 1> {
        PWM_2_ISC_INTCNTLOAD_W::new(self)
    }
    #[doc = "Bit 2 - Comparator A Up Interrupt"]
    #[inline(always)]
    #[must_use]
    pub fn pwm_2_isc_intcmpau(&mut self) -> PWM_2_ISC_INTCMPAU_W<_2_ISC_SPEC, 2> {
        PWM_2_ISC_INTCMPAU_W::new(self)
    }
    #[doc = "Bit 3 - Comparator A Down Interrupt"]
    #[inline(always)]
    #[must_use]
    pub fn pwm_2_isc_intcmpad(&mut self) -> PWM_2_ISC_INTCMPAD_W<_2_ISC_SPEC, 3> {
        PWM_2_ISC_INTCMPAD_W::new(self)
    }
    #[doc = "Bit 4 - Comparator B Up Interrupt"]
    #[inline(always)]
    #[must_use]
    pub fn pwm_2_isc_intcmpbu(&mut self) -> PWM_2_ISC_INTCMPBU_W<_2_ISC_SPEC, 4> {
        PWM_2_ISC_INTCMPBU_W::new(self)
    }
    #[doc = "Bit 5 - Comparator B Down Interrupt"]
    #[inline(always)]
    #[must_use]
    pub fn pwm_2_isc_intcmpbd(&mut self) -> PWM_2_ISC_INTCMPBD_W<_2_ISC_SPEC, 5> {
