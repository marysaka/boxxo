...
pub type R = crate::R<_1_DBRISE_SPEC>;
#[doc = "Register `_1_DBRISE` writer"]
pub type W = crate::W<_1_DBRISE_SPEC>;
#[doc = "Field `PWM_1_DBRISE_RISEDELAY` reader - Dead-Band Rise Delay"]
pub type PWM_1_DBRISE_RISEDELAY_R = crate::FieldReader<u16>;
#[doc = "Field `PWM_1_DBRISE_RISEDELAY` writer - Dead-Band Rise Delay"]
pub type PWM_1_DBRISE_RISEDELAY_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 12, O, u16>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pwm_1_dbrise_risedelay(&mut self) -> PWM_1_DBRISE_RISEDELAY_W<_1_DBRISE_SPEC, 0> {
