...
pub type R = crate::R<_2_CMPB_SPEC>;
#[doc = "Register `_2_CMPB` writer"]
pub type W = crate::W<_2_CMPB_SPEC>;
#[doc = "Field `PWM_2_CMPB_COMPB` reader - Comparator B Value"]
pub type PWM_2_CMPB_COMPB_R = crate::FieldReader<u16>;
#[doc = "Field `PWM_2_CMPB_COMPB` writer - Comparator B Value"]
pub type PWM_2_CMPB_COMPB_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 16, O, u16>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pwm_2_cmpb_compb(&mut self) -> PWM_2_CMPB_COMPB_W<_2_CMPB_SPEC, 0> {
...
#[doc = "PWM2 Compare B\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`_2_cmpb::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`_2_cmpb::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
