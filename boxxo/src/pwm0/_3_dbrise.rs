...
pub type R = crate::R<_3_DBRISE_SPEC>;
#[doc = "Register `_3_DBRISE` writer"]
pub type W = crate::W<_3_DBRISE_SPEC>;
#[doc = "Field `PWM_3_DBRISE_RISEDELAY` reader - Dead-Band Rise Delay"]
pub type PWM_3_DBRISE_RISEDELAY_R = crate::FieldReader<u16>;
#[doc = "Field `PWM_3_DBRISE_RISEDELAY` writer - Dead-Band Rise Delay"]
pub type PWM_3_DBRISE_RISEDELAY_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 12, O, u16>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pwm_3_dbrise_risedelay(&mut self) -> PWM_3_DBRISE_RISEDELAY_W<_3_DBRISE_SPEC, 0> {
...
#[doc = "PWM3 Dead-Band Rising-Edge Delay\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`_3_dbrise::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`_3_dbrise::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
