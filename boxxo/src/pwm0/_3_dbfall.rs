...
pub type R = crate::R<_3_DBFALL_SPEC>;
#[doc = "Register `_3_DBFALL` writer"]
pub type W = crate::W<_3_DBFALL_SPEC>;
#[doc = "Field `PWM_3_DBFALL_FALLDELAY` reader - Dead-Band Fall Delay"]
pub type PWM_3_DBFALL_FALLDELAY_R = crate::FieldReader<u16>;
#[doc = "Field `PWM_3_DBFALL_FALLDELAY` writer - Dead-Band Fall Delay"]
pub type PWM_3_DBFALL_FALLDELAY_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 12, O, u16>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pwm_3_dbfall_falldelay(&mut self) -> PWM_3_DBFALL_FALLDELAY_W<_3_DBFALL_SPEC, 0> {
...
#[doc = "PWM3 Dead-Band Falling-Edge-Delay\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`_3_dbfall::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`_3_dbfall::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
