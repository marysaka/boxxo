...
pub type R = crate::R<_2_FLTSTAT0_SPEC>;
#[doc = "Field `PWM_2_FLTSTAT0_FAULT0` reader - Fault Input 0"]
pub type PWM_2_FLTSTAT0_FAULT0_R = crate::BitReader;
#[doc = "Field `PWM_2_FLTSTAT0_FAULT1` reader - Fault Input 1"]
pub type PWM_2_FLTSTAT0_FAULT1_R = crate::BitReader;
impl R {
...
#[doc = "PWM2 Fault Status 0\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`_2_fltstat0::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
