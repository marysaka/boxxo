...
pub type R = crate::R<_3_DBCTL_SPEC>;
#[doc = "Register `_3_DBCTL` writer"]
pub type W = crate::W<_3_DBCTL_SPEC>;
#[doc = "Field `PWM_3_DBCTL_ENABLE` reader - Dead-Band Generator Enable"]
pub type PWM_3_DBCTL_ENABLE_R = crate::BitReader;
#[doc = "Field `PWM_3_DBCTL_ENABLE` writer - Dead-Band Generator Enable"]
pub type PWM_3_DBCTL_ENABLE_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pwm_3_dbctl_enable(&mut self) -> PWM_3_DBCTL_ENABLE_W<_3_DBCTL_SPEC, 0> {
...
#[doc = "PWM3 Dead-Band Control\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`_3_dbctl::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`_3_dbctl::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
