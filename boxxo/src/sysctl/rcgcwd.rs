...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn sysctl_rcgcwd_r0(&mut self) -> SYSCTL_RCGCWD_R0_W<RCGCWD_SPEC, 0> {
        SYSCTL_RCGCWD_R0_W::new(self)
    }
    #[doc = "Bit 1 - Watchdog Timer 1 Run Mode Clock Gating Control"]
    #[inline(always)]
    #[must_use]
    pub fn sysctl_rcgcwd_r1(&mut self) -> SYSCTL_RCGCWD_R1_W<RCGCWD_SPEC, 1> {
...
#[doc = "Watchdog Timer Run Mode Clock Gating Control\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`rcgcwd::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`rcgcwd::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
