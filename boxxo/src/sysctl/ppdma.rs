...
pub type R = crate::R<PPDMA_SPEC>;
#[doc = "Register `PPDMA` writer"]
pub type W = crate::W<PPDMA_SPEC>;
#[doc = "Field `SYSCTL_PPDMA_P0` reader - uDMA Module Present"]
pub type SYSCTL_PPDMA_P0_R = crate::BitReader;
#[doc = "Field `SYSCTL_PPDMA_P0` writer - uDMA Module Present"]
pub type SYSCTL_PPDMA_P0_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn sysctl_ppdma_p0(&mut self) -> SYSCTL_PPDMA_P0_W<PPDMA_SPEC, 0> {
